...
import utils.mobius_operations as mobius
    ...
    def forward(self, hidden_states, hidden_states2=None, l=None, mix_layer=1000, attention_mask=None, attention_mask2=None, head_mask=None):
        ...
        if mix_layer == -1:
            if hidden_states2 is not None:
                hidden_states_1 = self.pmath_geo.expmap0(hidden_states, c=torch.tensor([1.0], device='cuda'))
                hidden_states_2 = self.pmath_geo.expmap0(hidden_states2, c=torch.tensor([1.0], device='cuda'))
                weighted_hidden_states_1 = mobius.scalar_mul(torch.tensor([l], device='cuda'), hidden_states_1, c=torch.tensor([1.0], device='cuda'))
                weighted_hidden_states_2 = mobius.scalar_mul(torch.tensor([1-l], device='cuda'), hidden_states_2, c=torch.tensor([1.0], device='cuda'))
                hidden_states_1_plus_2 = mobius.add(weighted_hidden_states_1, weighted_hidden_states_2, c=torch.tensor([1.0], device='cuda'))
                hidden_states = self.pmath_geo.logmap0(hidden_states_1_plus_2, c=torch.tensor([1.0], device='cuda'))
