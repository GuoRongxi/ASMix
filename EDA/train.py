...
parser.add_argument('--dataset_filepath', default='../data/cade', type=str)
parser.add_argument('--save_filepath', default='../log/cade', type=str)
parser.add_argument('--comment', default='EDA on cade', type=str)
...
def main():
    ...
    train_dataset, val_dataset, n_labels = get_dataset(args.dataset_filepath, args.max_seq_len)
